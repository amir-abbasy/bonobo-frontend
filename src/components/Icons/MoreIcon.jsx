...
function MoreIcon({ w = '24', h = '24', className = '', color = "black" }) {
  return (
    <svg width={w} height={h} className={"cursor-pointer group " + className} viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
      ...
      <path d="M15.994 12H16.003" className='stroke-black group-hover:stroke-brand-primary' strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" />
      <path d="M11.995 12H12.004" className='stroke-black group-hover:stroke-brand-primary' strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" />
      <path d="M7.99501 12H8.00401" className='stroke-black group-hover:stroke-brand-primary' strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" />
    </svg>
  )
}
