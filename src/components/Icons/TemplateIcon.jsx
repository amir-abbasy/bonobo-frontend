...
function TemplateIcon({ w = '24', h = '24', className = '' }) {
  return (
    <svg width={w} height={h} className={"cursor-pointer " + className} viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
      ...
      <path stroke="black" className='icon-group-hover:stroke-brand-primary' d="M6.0708 16.4589C6.0708 16.4589 6.8828 14.8219 8.0648 14.8219C9.2468 14.8219 9.8508 16.1969 11.1608 16.1969C12.4698 16.1969 13.9388 12.7489 15.4228 12.7489C16.9048 12.7489 17.9708 15.1399 17.9708 15.1399"  stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round" />
      <path  className='icon-group-hover:stroke-brand-primary' d="M10.1389 9.10487C10.1389 9.96487 9.44193 10.6629 8.58093 10.6629C7.72093 10.6629 7.02393 9.96487 7.02393 9.10487C7.02393 8.24487 7.72093 7.54688 8.58093 7.54688" stroke="black" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round" />
      <path stroke="black" className='icon-group-hover:stroke-brand-primary' d="M15.531 20.9721C19.747 20.1791 21.25 17.5921 21.25 12.0001C21.25 5.06312 18.937 2.75012 12 2.75012C5.063 2.75012 2.75 5.06312 2.75 12.0001C2.75 18.9371 5.063 21.2501 12 21.2501"  stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round" />
    </svg>
  )
}
